...
<section class="about-section">
  <div class="about-container">
    ...
    <div class="about-left">
      <div class="image-wrap animate__animated animate__zoomIn animate__delay-1s">
        <img src="decorevistaimages/7baf8959623f504269f65a9b9c488ba9.jpg" style="border-radius: 100%;" alt="DecorVista Experience" />
        <div class="experience-label animate__animated animate__fadeInLeft animate__delay-2s">
          15<span>Years of Craftsmanship</span>
        </div>
      </div>
    </div>
    ...
    <div class="about-right">
      <div class="about-text">
        <h2 class="animate__animated animate__fadeInUp">
          Discover the Art of Home <br> at DecorVista
        </h2>
        <p class="sub animate__animated animate__fadeInUp animate__delay-1s">
          Where elegance meets comfort – transform your living space with our curated furniture and decor.
        </p>
        <p class="animate__animated animate__fadeInUp animate__delay-2s">
          At DecorVista, we believe your home deserves more than just furniture — it deserves style and personality. With over 15 years of trusted craftsmanship, we offer bespoke furniture, exquisite décor pieces, and interior solutions that elevate any space. From modern minimalism to timeless classics, we help you create spaces you’ll love to live in.
        </p>
        <a href="#" class="about-btn animate__animated animate__fadeInUp animate__delay-3s">
...
<section class="services-section">
  <div class="section-header" data-aos="fade-up">
    ...
    <h2>Our Services</h2>
    <p>We provide a full range of home furnishing and interior solutions to redefine your living spaces.</p>
  </div>
  ...
  <div class="services-grid">
    ...
    <div class="service-card" data-aos="fade-up" data-aos-delay="100">
      <div class="service-content">
        ...
        <p>Get bespoke furniture crafted to your style, size, and comfort preferences.</p>
    ...
    <div class="service-card" data-aos="fade-up" data-aos-delay="200">
      <div class="service-content">
        ...
        <p>Professional guidance on home decor, color schemes, and layout planning.</p>
        <a href="#">Read More <i class="fas fa-arrow-right"></i></a>
      </div>
    </div>
    ...
    <div class="service-card" data-aos="fade-up" data-aos-delay="300">
      <div class="service-content">
        <div class="icon"><i class="fas fa-couch"></i></div>
        <h3>Living Room Makeovers</h3>
        <p>Transform your living spaces with our curated furniture sets and decor accents.</p>
        <a href="#">Read More <i class="fas fa-arrow-right"></i></a>
      </div>
    </div>
    ...
    <div class="service-card" data-aos="fade-up" data-aos-delay="400">
      <div class="service-content">
        ...
        <p>Create functional and stylish workspaces with ergonomic furniture solutions.</p>
        <a href="#">Read More <i class="fas fa-arrow-right"></i></a>
      </div>
    </div>
    ...
    <div class="service-card" data-aos="fade-up" data-aos-delay="500">
      <div class="service-content">
        ...
        <p>Brighten up your home with elegant lighting and decorative pieces.</p>
        <a href="#">Read More <i class="fas fa-arrow-right"></i></a>
      </div>
    </div>
    ...
    <div class="service-card" data-aos="fade-up" data-aos-delay="600">
      <div class="service-content">
        ...
        <h3>Full Home Solutions</h3>
        <p>Comprehensive packages including furniture, decor, and styling consultation.</p>
        <a href="#">Read More <i class="fas fa-arrow-right"></i></a>
      </div>
    </div>
  </div>
...
<section class="working-hours-section" data-aos="fade-up">
  <div class="section-heading">
    <div class="icon-ring"><i class="fa-solid fa-clock"></i></div>
    <h2>Working Hours</h2>
    <p>Our experts are here to serve you with the best grooming experience — choose your time and walk in!</p>
  </div>

  <div class="schedule-list">
    <div class="schedule-box">
      <h3 class="title">Weekdays</h3>
      <p class="time">9AM - 9PM</p>
    </div>
    <div class="schedule-box">
      <h3 class="title">Saturday</h3>
      <p class="time">10AM - 9PM</p>
    </div>
    <div class="schedule-box">
      <h3 class="title">Sunday</h3>
      <p class="time closed">Closed</p>
    </div>
  </div>
</section>
